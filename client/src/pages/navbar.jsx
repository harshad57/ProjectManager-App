  ...
  return (
    <nav className="flex z-60 justify-between items-center gap-10 lg:px-8 lg:py-3 py-4 px-4 rounded-xl shadow-md backdrop-blur-md border border-gray-200 fixed w-full">
      ...
      <div className={`flex lg:flex-row flex-col absolute lg:relative right-0 top-0 gap-6 items-center bg-white lg:px-6 px-15 w-3/4 lg:w-auto lg:py-3 pt-15 lg:rounded-xl lg:translate-x-0 rounded-l-lg min-h-screen lg:min-h-auto shadow-md ${open ? "translate-x-0" : "translate-x-full"} transition duration-200`}>
        ...
        <button onClick={btn} className="text-center rounded-lg absolute bottom-15 flex lg:hidden bg-indigo-600 mx-auto sm:w-34 px-6 py-2 text-md font-semibold text-white shadow-md transition hover:bg-indigo-700 cursor-pointer">
